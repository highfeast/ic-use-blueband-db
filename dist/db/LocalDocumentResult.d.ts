...
import { QueryResult, DocumentChunkMetadata, Tokenizer, DocumentTextSection } from "../utils/types";
/**
...
export declare class LocalDocumentResult extends LocalDocument {
     ...
     */
    constructor(index: LocalDocumentIndex, id: string, title: string, chunks: QueryResult<DocumentChunkMetadata>[], tokenizer: Tokenizer);
    /**
